...
public class GeneralServiceImpl implements GeneralService {
  ...
  @Autowired
  public GeneralServiceImpl(AuthServiceImpl authService, PostRepository postRepository,
      PostCommentRepository commentRepository, TagRepository tagRepository,
  ...
  public Tags getTags(String query) {
    List<Tag> tagList = tagRepository.getRelevantTags(query);
  ...
  public CalendarResponse getCalendar(Integer year) {
    ...
    postRepository.getCalendarQuery(year)
        .forEach(o -> posts.put(dateFormat.format(o.getDate()), o.getCount()));
  ...
  public ProfileEditResponse editProfile(ProfileEditRequest request, User user,
    ...
    return userService.edit(request, user, response);
  }
