...
public class ViewModelFactory {
     ...
     */
    private static Post getPostOfType(PostModelType pt, main.model.Post post, UserFullInfo user, SimpleDateFormat sdf)
    {
        switch (pt)
        {
            case DEFAULT:
                return Post.builder()
                        ...
                        .dislikeCount((int) post.getPostVotes().stream().filter(vote -> !vote.isValue()).count())
